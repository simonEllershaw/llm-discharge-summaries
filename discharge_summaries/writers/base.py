...
class BaseStructuredDataExtractor:
    ...
    def complete_prsb_discharge_summary(self, hadm_id: str) -> DischargeSummary:
        return DischargeSummary(
            ...
            discharge_details=self.complete_discharge_details(hadm_id),
            person_completing_record=self.complete_person_completing_record(hadm_id),
            distribution_list=self.complete_distribution_list(hadm_id),
        )
