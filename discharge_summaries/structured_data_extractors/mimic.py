...
from discharge_summaries.structured_data_extractors.base import (
    BaseStructuredDataExtractor,
)


class MIMICStructuredDataExtractor(BaseStructuredDataExtractor):
